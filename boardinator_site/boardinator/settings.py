# Django settings for boardinator project.
...
DATABASES = {
    'default': {
        ...
        'NAME':  'boardinator',                      # Or path to database file if using sqlite3.
        'USER': 'boardinator_user',                      # Not used with sqlite3.
        'PASSWORD': 'wdr55FZJd247BNtQ9wVsB1k5suGm66',                  # Not used with sqlite3.
...
SECRET_KEY = 'Hwop#&x)V^"{6?GAf0[=F{ys3U;v3uY4f\U`%&w8$;l!bqeTq6'
...
ROOT_URLCONF = 'boardinator.urls'

WSGI_APPLICATION = 'boardinator.wsgi.application'
